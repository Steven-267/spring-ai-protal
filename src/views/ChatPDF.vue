        ...
        <div class="history-list">
          <div class="history-header">
            ...
            <div class="header-actions">
              ...
              <button class="clear-btn" title="清空PDF对话" @click.stop="clearAllChats">
...
// 删除某个会话
const deleteOneChat = async (chatId, idx) => {
  try {
...
const clearAllChats = async () => {
  try {
    await chatAPI.clearChats('pdf')
    chatHistory.value = []
    cleanupResources()
  } catch (e) {
    console.error('清空 PDF 会话失败:', e)
  }
}
</script>
    ...
    .history-list {
      ...
      padding: 1rem 0;
        ...
        span {
          ...
          .new-chat-btn { background: #9333ea; color: #fff; }
          .new-chat-btn:hover { background: #7e22ce; }
